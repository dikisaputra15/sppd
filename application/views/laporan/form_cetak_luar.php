        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">laporan berdasarkan tanggal SPPD Luar</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">laporan berdasarkan tangggal SPPD Luar</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="<?= base_url('laporan/lap_sppd_luar/cetakall'); ?>" method="POST" target="__blank">
                <div class="card-body">
                <div class="row">
                	<div class="col-md-12">
 					<div class="col-md-3">
