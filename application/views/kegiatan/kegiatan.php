...
<?php endif; ?>
 ...
 <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Kegiatan Dalam Daerah</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">kegiatan dalam daerah</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="card">
              <div class="card-header">
                <h3 class="card-title">Kegiatan Dalam Daerah</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php foreach ($kegiatan as $dat) : ?>
                      ...
                      <td>Rp. <?= number_format($dat['pagu_anggaran'], 0, '', '.'); ?></td>
	                    <td>
	                    	<a href="<?= base_url('kegiatan/kegiatan/hapus_kegiatan/') . $dat['no_kegiatan']; ?>" class="btn btn-danger tombol-hapus">Hapus</a>
                            <a href="<?= base_url('kegiatan/kegiatan/edit_kegiatan/') . $dat['no_kegiatan']; ?>" class="btn btn-primary">Edit</a>
	                    </td>
	                  </tr>
      ...
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="exampleModalLabel">Tambah Kegiatan Dalam Daerah</h5>
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
               </button>
            </div>
            <div class="modal-body">
               <form action="<?= base_url('kegiatan/kegiatan/tambahkegiatan') ?>" method="POST">
