      ...
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="exampleModalLabel">Form Perjalanan Dinas Dalam Daerah</h5>
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
               </button>
            </div>
            <div class="modal-body">
               <form action="<?= base_url('sppd_dalam/permohonan_dalam/tambahformdalam') ?>" method="POST">
                    ...
                    <label>Pekerjaan</label>
                     <select class="form-control" name="kegiatan">
                      ...
                      <?php foreach ($kegiatan as $dat) { ?>
                        <option value="<?= $dat['id_sppd_dalam']; ?>"><?= $dat['nama_pekerjaan']; ?></option>
                      <?php } ?>
                     </select>
                  </div>
                  <div class="form-group">
