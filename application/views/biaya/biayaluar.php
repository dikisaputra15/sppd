...
<?php endif; ?>
 ...
 <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Biaya SPPD Luar Daerah</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Biaya SPPD Luar Daerah</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="card">
              <div class="card-header">
                <h3 class="card-title">Biaya SPPD Luar Daerah</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <?php foreach ($biayaluar as $dat) : ?>
                     ...
                     <td>Rp. <?= number_format($dat['uang_gol1'], 0, '', '.'); ?></td>
                      ...
                      <td>Rp. <?= number_format($dat['uang_gol4'], 0, '', '.'); ?></td>
	                    <td>
	                    	<a href="<?= base_url('biaya/biayaluar/hapus_biaya/') . $dat['id_biaya_luar']; ?>" class="btn btn-danger tombol-hapus">Hapus</a>
                            <a href="<?= base_url('biaya/biayaluar/edit_biaya/') . $dat['id_biaya_luar']; ?>" class="btn btn-primary">Edit</a>
	                    </td>
	                  </tr>
      ...
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="exampleModalLabel">Tambah Biaya SPPD Biaya Luar</h5>
               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
               </button>
            </div>
            <div class="modal-body">
               <form action="<?= base_url('biaya/biayaluar/tambahbiayaluar') ?>" method="POST">
