              ...
              <p>mohon untuk dibuatkan surat perjalanan dinas dengan identitas berikut :</p>
                <table>
                    ...
                    <tr>
                      ...
                      <td>:</td>
                      <td><?= $viewluar['tujuan_p_dinas']; ?></td>
                    </tr>

                    <tr>
                      <td>Tanggal berangkat</td>
                      <td>:</td>
                      <td><?= $viewluar['tgl_berangkat']; ?></td>
                    </tr>

                    <tr>
                      <td>Tanggal kembali</td>
                      <td>:</td>
                      <td><?= $viewluar['tgl_kembali']; ?></td>
                    </tr>
                 
                  <tr>
                      <td>Tertanda</td>
                      <td>:</td>
                      <td><?= $viewluar['tertanda']; ?></td>
                    </tr>
                ...
                <a href="<?= base_url('sppd_luar/permohonan_luar/updatestatus/') . $viewluar['id_permohonan_luar']; ?>" class="btn btn-primary">Verifikasi</a>
              </div>
              <!-- /.card-body -->
      </div>
</div>
