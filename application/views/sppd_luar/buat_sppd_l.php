...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Buat SPPD luar daerah</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">buat SPPd luar daerah</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">buat SPPD luar daerah</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->

              <form role="form" action="<?= base_url('sppd_luar/sppd_luar/proses_sppd_luar') ?>" method="POST">
                <div class="card-body">

                   <div class="form-group" hidden>
                    <label for="exampleInputPassword1">id Permohonan luar</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" name="id_permohonan_luar" value="<?= $dat['id_permohonan_luar']; ?>">
                  </div>
                 ...
                 <div class="form-group" hidden>
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" name="id_biaya" value="<?= $dat['id_biaya_luar']; ?>">
                  </div>

                  <div class="form-group" hidden>
                    <label for="exampleInputPassword1">id sppd luar</label>
                    <input type="text" class="form-control" id="exampleInputPassword1" name="id_sppd_luarr" value="<?= $dat['id_sppd_luar']; ?>">
                  </div>
                   ...
                   <div class="form-group">
                    ...
                    $idluar = $dat['id_permohonan_luar'];
                    $query = $this->db->query("SELECT tb_detail_permohonan_luar.*, tb_pegawai.nip,tb_pegawai.nama FROM tb_detail_permohonan_luar JOIN tb_pegawai on tb_detail_permohonan_luar.nip=tb_pegawai.nip where tb_detail_permohonan_luar.id_permohonan_luar='$idluar'");

                      foreach ($query->result() as $row)
                      { ?>
                      
                         <input type="checkbox" name="pegawai[]" value="<?= $row->nip; ?>"><?= $row->nama; ?>
                         <select name="goluang[]">
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" name="id_pekerjaan" value="<?= $dat['id_pekerjaan_luar']; ?>" hidden>
                    <input type="text" class="form-control" id="exampleInputPassword1" value="<?= $dat['nama_pekerjaan_luar']; ?>" readonly>
                  </div>
